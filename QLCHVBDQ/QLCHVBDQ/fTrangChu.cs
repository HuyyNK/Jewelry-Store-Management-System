...
namespace QLCHVBDQ
{
    public partial class fTrangChu : Form
    {
        ...
        public void LoadTrangChu()
        {
            ...
            if (fLogin.userType == "1" || fLogin.userType == "2") pictureBoxSetiting.Visible = true;
            string query = "select count(MaLDV) from LOAIDICHVU";
            SoDichVu.Text = DataProvider.Instance.ExecuteScalar(query).ToString();
            query = "select count(MaSP) from SANPHAM";
            SoSanPham.Text = DataProvider.Instance.ExecuteScalar(query).ToString();
            query = "select count(MaNCC) from NHACUNGCAP";
            SoNCC.Text = DataProvider.Instance.ExecuteScalar(query).ToString();  
        }
        ...
        private void pictureBoxSetiting_Click(object sender, EventArgs e)
        {
            fCaiDat f = new fCaiDat();
            this.Hide();
            f.ShowDialog();
            if (fNhanVien.flag == 1) this.Close();
            this.Show();
        }
        ...
        private void textSanPham_Click(object sender, EventArgs e)
        {
            fSanPham f = new fSanPham();
            this.Hide();
            f.ShowDialog();
        ...
        private void SoDichVu_Click(object sender, EventArgs e)
        {
            fLoaiDichVu f = new fLoaiDichVu();
            this.Hide();
            f.ShowDialog();
        ...
        private void textDichVu_Click(object sender, EventArgs e)
        {
            fLoaiDichVu f = new fLoaiDichVu();
            this.Hide();
            f.ShowDialog();
        ...
        private void SoNCC_Click(object sender, EventArgs e)
        {
            fNhaCungCap f = new fNhaCungCap();
            this.Hide();
            f.ShowDialog();
        ...
        private void textNCC_Click(object sender, EventArgs e)
        {
            fNhaCungCap f = new fNhaCungCap();
            this.Hide();
            f.ShowDialog();
        ...
        private void imgDichVu_Click(object sender, EventArgs e)
        {
