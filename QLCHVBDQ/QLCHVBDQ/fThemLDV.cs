...
namespace QLCHVBDQ
{
    public partial class fThemLDV : Form
    {
        ...
        private void textMaLDV_Click(object sender, EventArgs e)
        {

        }

        private void textTenLDV_Click(object sender, EventArgs e)
        {

        }

        private void textBoxMaLDV_TextChanged(object sender, EventArgs e)
        {
