...
namespace QLCHVBDQ
{
    public partial class fThemPDV : Form
    {
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            ...
            string NgayLap = dateNgayLapPhieu.Value.ToString("yyyy/MM/dd");
        ...
        private void textThemPDV_Click(object sender, EventArgs e)
        {
        ...
        private void dateNgayLapPhieu_ValueChanged(object sender, EventArgs e)
        {
