...
namespace QLCHVBDQ
{
    public partial class fThemDVT : Form
    {
        ...
        private void textThemLDV_Click(object sender, EventArgs e)
        {

        }

        private void textBoxMaDVT_TextChanged(object sender, EventArgs e)
        {

        }

        private void textBoxTenDVT_TextChanged(object sender, EventArgs e)
        {
