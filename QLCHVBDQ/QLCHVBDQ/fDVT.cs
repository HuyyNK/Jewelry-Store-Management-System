...
namespace QLCHVBDQ
{
    public partial class fDVT : Form
    {
        ...
        private void btnXuatExcel_Click(object sender, EventArgs e)
        {
            ...
            saveFileDialog.FileName = "BangDonViTinh.xlsx";

            if (saveFileDialog.ShowDialog() == DialogResult.OK)
            {
                string filePath = saveFileDialog.FileName;
                DataTable dataTable = GetDataTableFromDataGridView(dtgvDVT); // Hàm lấy dữ liệu từ DataGridView
        ...
        public void ExportToExcel(DataTable dataTable, string filePath)
        {
            ...
            {
                var worksheet = workbook.Worksheets.Add(dataTable, "Don vi tinh");
