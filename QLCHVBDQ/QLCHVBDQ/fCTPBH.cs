...
namespace QLCHVBDQ
{
    public partial class fCTPBH : Form
    {
        ...
        {
            string query = String.Format("select SoPhieu, NgayLap, KHACHHANG.TenKH, KHACHHANG.SDT, TongTien  from PHIEUBANHANG, KHACHHANG where SoPhieu = '{0}' and KHACHHANG.MaKH = PHIEUBANHANG.MaKH", fBanHang.SoPhieu_selected);
        ...
        private void textThemCTPDV_Click(object sender, EventArgs e)
        {
