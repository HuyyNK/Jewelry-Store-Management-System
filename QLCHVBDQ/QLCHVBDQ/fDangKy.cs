...
namespace QLCHVBDQ
{
    public partial class fDangKy : Form
    {
        ...
        private void textNgaySinh_Click(object sender, EventArgs e)
        {
        ...
        private void comBoxGioiTinh_SelectedIndexChanged(object sender, EventArgs e)
        {

        }

        private void textTenTK_TextChanged(object sender, EventArgs e)
        {
